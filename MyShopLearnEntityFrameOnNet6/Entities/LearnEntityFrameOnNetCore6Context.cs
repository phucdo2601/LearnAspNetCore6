...
namespace MyShopLearnEntityFrameOnNet6.Entities
{
    public partial class LearnEntityFrameOnNetCore6Context : DbContext
    {
        public LearnEntityFrameOnNetCore6Context()
        {
        }

        public LearnEntityFrameOnNetCore6Context(DbContextOptions<LearnEntityFrameOnNetCore6Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-7CKON28R\\SQLEXPRESS;Initial Catalog=LearnEntityFrameOnNetCore6;User ID=sa;Password=12345678");
            }
        }
